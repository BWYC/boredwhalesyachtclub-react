...
const NAVI = (props) => {
  return (
    <div className={`navi-container ${props.rootClassName} `}>
      <header data-thq="thq-navbar" className="navi-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navi-desktop-menu">
          ...
          <div className="navi-buttons">
            <button className="navi-register button">CONNECT WALLET</button>
          </div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="navi-mobile-menu">
          <div className="navi-nav">
            <div className="navi-top">
              <img alt="image" src="/whls-1500h.gif" className="navi-logo" />
              <div data-thq="thq-close-menu" className="navi-close-menu">
                <svg viewBox="0 0 1024 1024" className="navi-icon02">
                  <path
          ...
          <div className="">
            <svg viewBox="0 0 950.8571428571428 1024" className="navi-icon04">
              <path
            ...
            <svg viewBox="0 0 877.7142857142857 1024" className="navi-icon06">
              <path
            ...
            <svg viewBox="0 0 602.2582857142856 1024" className="navi-icon08">
              <path
